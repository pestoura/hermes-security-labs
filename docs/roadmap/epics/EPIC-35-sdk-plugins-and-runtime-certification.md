...
- SDK and certification specification

## 11. Acceptance criteria

- Uncertified extensions are refused
- Granted permissions never exceed the declared manifest

## 12. Evidence and validation plan

- Conformance results per extension
