...
from devsecops_runbooks.adapters import build_adapter
from devsecops_runbooks.contracts import Decision, ExecutionRequest, ExecutionResult, Status
from devsecops_runbooks.execution import CommandError, CommandRunner
from devsecops_runbooks.policy import (
    PolicyViolation,
    authorise_request,
    is_implemented_handler,
)
from devsecops_runbooks.sanitizer import sanitize_mapping
...
def dispatch(
    ...
    try:
        adapter = build_adapter(request, runner=runner)
