...
def main() -> int:
    ...
    if args.mode == "success":
        print("synthetic-devsecops-supervised-success", flush=True)
        return 0

    if args.mode == "execution-fail":
        print("synthetic-devsecops-supervised-failure", file=sys.stderr, flush=True)
        return 9
